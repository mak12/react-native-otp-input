    ...
    constructor(props) {
        ...
        this.renderOneInputField = (_, index) => {
            ...
            return (<View pointerEvents="none" key={index + "view"} testID="inputSlotView">
                <TextInput testID="textInput" underlineColorAndroid='rgba(0,0,0,0)' style={selectedIndex === index ? [defaultTextFieldStyle, codeInputFieldStyle, codeInputHighlightStyle] : (selectedIndex < index ? [defaultTextFieldStyle, codeInputFieldStyle] : [defaultTextFieldStyle, codeInputFilledStyle])} ref={ref => { this.fields[index] = ref; }} onChangeText={text => {
                    this.handleChangeText(index, text);
